...
return function(colors, highlight)
    ...
    highlight('Underlined', { underdotted = false })
    highlight('@boolean', { fg = C.red2, italic = true })
    ...
    highlight('@text.uri', { fg = C.blue2, underdotted = false })
    ...
    highlight('helpHyperTextEntry', { fg = C.blue2, underdotted = false })
    highlight('helpSectionDelim', { fg = C.red2, bold = true })
    highlight('helpHyperTextJump', { fg = C.blue2, underdotted = false })
    ...
    highlight('NvimTreeOpenedFolderName', { underdotted = false })
    ...
    highlight('NvimTreeGitDirty', text_yellow)
